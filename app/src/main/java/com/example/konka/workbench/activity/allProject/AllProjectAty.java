 ...
 * 所有项目
 */
public class AllProjectAty extends Activity implements IAllProjectView {
    ...
    private AllProjectPresenter allProjectPresenter = new AllProjectPresenter(this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.projectlist_page);
        initListener();
        allProjectPresenter.findAllProject();
        mDrawerLayout = (DrawerLayout) findViewById(R.id.drawer_layout);
        mDrawerLayout.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED);//关闭手势滑动
        mFilterListView = (ExpandableListView) findViewById(R.id.menu_listView);
        initData();
    ...
    private void initListener() {
        ...
        Button confirm = (Button) findViewById(R.id.ok_bn);
        Button reset = (Button) findViewById(R.id.cancel_bn);
        /*展示筛选菜单*/
        filter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mDrawerLayout.openDrawer(findViewById(R.id.menu_layout));
                // ExpandableGridAdapter adapter = new ExpandableGridAdapter(MainActivity.this);
                ExpandableGridAdapter adapter = new ExpandableGridAdapter(AllProjectAty.this, item, selectedData);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                allProjectPresenter.projectFilter(selectedData);
            }
        });
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDrawerLayout.closeDrawer(findViewById(R.id.menu_layout));
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case ContextValue.PROJECT_OPERATE:
                if (resultCode == RESULT_OK) {//删除项目成功
                ...
                } else if (resultCode == RESULT_CANCELED) {//项目有更新，重查更新视图
                    String projectId = data.getStringExtra(ContextValue.PROJECT_ID);
                    allProjectPresenter.getProject(projectId);
                }
                break;
        }
    }
    ...
    public void filterRefresh(List<Project> list) {
        showListView(list);
        mDrawerLayout.closeDrawer(findViewById(R.id.menu_layout));//关闭侧滑菜单
    }
    ...
    private void showListView(final List<Project> myList) {
        madapter = new ProjectAdapter(AllProjectAty.this, R.layout.mypro_item, myList);
        mlistview = (ListView) findViewById(R.id.lv_plist);
        ...
        mlistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {//子项点击事件
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AllProjectAty.this, DetailProjectAty.class);
